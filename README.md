...
![PPTX 메모와 엑셀 피벗 캐시](docs/speaker-cache.svg)

![PPTX 마스터와 PDF 첨부 명세](docs/master-embed.svg)
...
![엑셀 시트 이름과 데이터 연결](docs/sheet-connections.svg)

![정의된 이름 속성과 PDF 이름 목적지](docs/dest-names.svg)

![엑셀 하이퍼링크 표시와 PDF 대체 텍스트](docs/link-alts.svg)

![ODF 양식 머리말과 EPUB OPF 서지](docs/style-opf.svg)
